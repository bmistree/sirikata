...
std.featureObject.FeatureChangeTransaction.protototype.addField = function(index,data)
{
    var actionToTake =
...
std.featureObject.FeatureChangeTransaction.protototype.changeField = function(index,data)
{
    var actionToTake =
...
std.featureObject.FeatureChangeTransaction.protototype.removeField = function(index)
{
    var actionToTake =
